...
\begin{tikzpicture}[vcenter, scale=0.4]
    ...
    \coordinate[label={[yshift=-3pt]center:\tiny$s$}] () at (0,0);
    \coordinate[label={[yshift=-3pt]center:\tiny$s$}] () at (1,0);
    \coordinate[label={[yshift=-3pt]center:\tiny$s$}] () at (2,0);
    \coordinate[label={[yshift=-3pt]center:\tiny$s$}] () at (3,0);
    \coordinate[label={[yshift=3pt]center:\tiny$s$}] () at (1.5,4);
    \coordinate[label={[yshift=3pt]center:\tiny$s$}] () at (3.5,4);
    \coordinate[label={[yshift=3pt]center:\tiny$s$}] () at (2.5,4);
    %
