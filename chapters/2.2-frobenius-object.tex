...
To further simply the diagrams, we stop labelling the functions and draw the structure maps as univalent and trivalent vertices
\begin{gather*}
...
We can therefore consider the diagrams generated by concatenations of Frobenius structure maps up to planar isotopy. That is, we equate two diagrams if one diagram can be continuous deformed to the other in the plane without crossing itself. In this way, we can just use our visual intuition in place of applying specific isotopy relations \eqref{rel:frob-isotopy1}-\eqref{rel:frob-isotopy3}.
...
Note that the Frobenius relation \eqref{rel:frob-relation} implies the associativity and coassociativity relations \eqref{rel:frob-associativity} by isotopy. For instance, we have
\begin{gather}
